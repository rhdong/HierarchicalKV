...
See [`benchmark/README.md`](benchmark/README.md) for the paper↔script
mapping, per-experiment build/run commands, and expected numbers. A
one-shot runner for the full suite is at
