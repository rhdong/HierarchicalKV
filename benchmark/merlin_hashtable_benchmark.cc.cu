...
int main() {
  size_t key_num_per_op = 16 * 1024UL;
  ...
  print_title();
  try {
    test_main(4, 1 * 1024 * 1024UL, key_num_per_op, 32, 0.50);
    test_main(4, 1 * 1024 * 1024UL, key_num_per_op, 32, 0.75);
    test_main(4, 1 * 1024 * 1024UL, key_num_per_op, 32, 1.00);
